...
public class PartieAttenteActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listPAAdapter = new PartieAttenteListAdapter(getApplicationContext(),
				0, listPA);

		// ArrayAdapter adapter = new ArrayAdapter<Integer>(this,
		// android.R.layout.simple_list_item_1, listPA);

		((ListView) this.findViewById(R.id.listViewPartieAttente))
				.setAdapter(listPAAdapter);
